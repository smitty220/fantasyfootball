...
import app.models  # noqa: F401  (register all models on Base before autogenerate)
...
# actually configured to use (env var / .env / default). A caller driving
# Alembic programmatically (see app/migrations.py) may already have set
# sqlalchemy.url on this exact Config object (e.g. to point at a specific
# engine/temp DB for verification) -- respect that instead of clobbering it.
